...
namespace Dashboard
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        public static List<Top_Tweets> GetTopTweets()
        {
            ...
            using (SqlCommand cmd = new SqlCommand("dbo.sp_top_tweets_numbered_live", obj_Conn))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.ExecuteNonQuery();

                obj_DA.SelectCommand = cmd;
                //Create a datatable to fill the info with 
        ...
        public static List<Most_Retweets> GetMostRetweets()
        {
            ...
            using (SqlCommand cmd = new SqlCommand("dbo.sp_most_retweets_numbered_live", obj_Conn))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.ExecuteNonQuery();
        ...
        public static List<Time_Series> GetTimeSeries()
        {
            ...
            using (SqlCommand cmd = new SqlCommand("dbo.sp_time_series_data_3_day_live", obj_Conn))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.ExecuteNonQuery();
        ...
        protected void GetTopTweetsText()
        {
            ...
            using (SqlCommand cmd = new SqlCommand("dbo.sp_top_tweets_with_text_live", obj_Conn))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.ExecuteNonQuery();
        ...
        protected void GetMostRetweetsText()
        {
            ...
            using (SqlCommand cmd = new SqlCommand("dbo.sp_most_retweets_with_text_live", obj_Conn))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.ExecuteNonQuery();
